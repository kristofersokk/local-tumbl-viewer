...
const MobileMenu = ({ children }: MobileMenuProps) => {
	return (
		<Dialog.Root>
			...
			<Dialog.Portal>
				<Dialog.Overlay className="MobileMenuOverlay z-popover fixed inset-0 backdrop-blur-xl backdrop-brightness-75" />
				<Dialog.Content className="MobileMenuContent bg-navbar border-navbar-border z-popover fixed inset-y-0 right-0 flex w-72 max-w-[85vw] flex-col gap-4 border-l p-4 shadow-2xl">
